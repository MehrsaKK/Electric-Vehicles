...
# (2b - parameters) The parameters refer to the estimators (outputs) that the model generates.
# (2c - model) The model is the combination of inputs and how it established a relation with outputs to produce the estimates.
...
# (3a - non-informative prior) The wider the selected variance, the more uninformative the prior.
...
# (3b - informative prior) The informative prior includes more precise variances which are adapted from Khaleghikarahrodi and Macht (2023b).
```{r informative prior} 
